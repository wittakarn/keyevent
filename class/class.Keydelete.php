...
class Keydelete
{
	...
	public function create($userId){
		...
		foreach ($params as $row) {
			$query = "INSERT INTO keydelete(id, input, keyup_timestamp, keydown_timestamp, position, reference_position, delete_count) VALUES (:id, :input, :keyup_timestamp, :keydown_timestamp, :position, :reference_position, :delete_count)";
